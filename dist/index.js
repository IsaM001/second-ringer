...
/*$vite$:1*/`),
  ...
  const ht = (o) => new X(typeof o == "string" ? o : o + "", void 0, I),
    lt = (o, ...t) => {
      const e =
        o.length === 1
          ? o[0]
  ...
  const {
    ...
    F = M.trustedTypes,
    _t = F ? F.emptyScript : "",
    gt = M.reactiveElementPolyfillSupport,
    E = (o, t) => o,
    T = {
      toAttribute(o, t) {
        switch (t) {
  ...
  let v = class extends HTMLElement {
    ...
    static getPropertyDescriptor(t, e, s) {
      const { get: i, set: n } = pt(this.prototype, t) ?? {
        get() {
          return this[e];
        },
        set(r) {
    ...
    _$ET(t, e) {
      ...
      if (i !== void 0 && s.reflect === !0) {
        const n = (
          s.converter?.toAttribute !== void 0 ? s.converter : T
    ...
    C(t, e, { useDefault: s, reflect: i, wrapped: n }, r) {
      (s &&
        ...
        (this._$Ej.set(t, r ?? e ?? this[t]), n !== !0 || r !== void 0)) ||
        (this._$AL.has(t) ||
  ...
  (v.elementStyles = []),
    ...
    gt?.({ ReactiveElement: v }),
    (M.reactiveElementVersions ??= []).push("2.1.1");
  const j = globalThis,
    R = j.trustedTypes,
    Z = R ? R.createPolicy("lit-html", { createHTML: (o) => o }) : void 0,
    Q = "$lit$",
    ...
    z = Array.isArray,
    vt = (o) => z(o) || typeof o?.[Symbol.iterator] == "function",
    q = `[ 	
\f\r]`,
    C = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
    tt = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  const bt = (o, t) => {
    ...
    for (let h = 0; h < e; h++) {
      ...
      let d,
        ...
        l = -1,
        p = 0;
      for (; p < a.length && ((r.lastIndex = p), (u = r.exec(a)), u !== null); )
        (p = r.lastIndex),
          r === C
            ? u[1] === "!--"
              ? (r = tt)
              ...
              ? (r = et)
              : u[2] !== void 0
              ? (ot.test(u[2]) && (i = RegExp("</" + u[2], "g")), (r = _))
              : u[3] !== void 0 && (r = _)
            : r === _
            ? u[0] === ">"
              ? ((r = i ?? C), (l = -1))
              : u[1] === void 0
              ? (l = -2)
              : ((l = r.lastIndex - u[2].length),
                (d = u[1]),
                (r = u[3] === void 0 ? _ : u[3] === '"' ? it : st))
            : r === it || r === st
            ? (r = _)
            : r === tt || r === et
            ? (r = C)
            : ((r = _), (i = void 0));
      const $ = r === _ && o[h + 1].startsWith("/>") ? " " : "";
      n +=
        r === C
          ? a + At
          : l >= 0
          ? (s.push(d), a.slice(0, l) + Q + a.slice(l) + f + $)
          : a + f + (l === -2 ? h : $);
    }
    return [
      at(
        o,
        n + (o[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")
      ),
      s,
    ];
  };
    ...
    constructor({ strings: t, _$litType$: e }, s) {
      ...
      for (; (i = g.nextNode()) !== null && a.length < h; ) {
        if (i.nodeType === 1) {
          ...
          if (i.data === Y) a.push({ type: 2, index: n });
          else {
            let l = -1;
  ...
  function b(o, t, e = o, s) {
    ...
    return (
      i?.constructor !== n &&
        (i?._$AO?.(!1),
        n === void 0 ? (i = void 0) : ((i = new n(o)), i._$AT(o, e, s)),
        s !== void 0 ? ((e._$Co ??= [])[s] = i) : (e._$Cl = i)),
      i !== void 0 && (t = b(o, i._$AS(o, t.values), i, s)),
      t
    );
  }
  class Et {
    ...
    u(t) {
      ...
      for (; a !== void 0; ) {
        if (r === a.index) {
          let d;
          a.type === 2
            ? (d = new O(n, n.nextSibling, this, t))
            : a.type === 1
            ? (d = new a.ctor(n, a.name, a.strings, this, t))
            : a.type === 6 && (d = new Pt(n, this, t)),
            this._$AV.push(d),
            (a = s[++h]);
        }
        r !== a?.index && ((n = g.nextNode()), r++);
      }
  ...
  class O {
      ...
      const { values: e, _$litType$: s } = t,
        i =
          typeof s == "number"
            ? this._$AC(t)
            : (s.el === void 0 &&
                (s.el = P.createElement(at(s.h, s.h[0]), this.options)),
              s);
      if (this._$AH?._$AD === i) this._$AH.p(e);
      else {
        const n = new Et(i, this),
          r = n.u(this.options);
    ...
    k(t) {
      ...
      for (const n of t)
        i === e.length
          ? e.push((s = new O(this.O(S()), this.O(S()), this, this.options)))
          : (s = e[i]),
          s._$AI(n),
          i++;
  ...
  Ot?.(P, O), (j.litHtmlVersions ??= []).push("3.3.1");
  const kt = (o, t, e) => {
  ...
  class k extends v {
    ...
    update(t) {
      ...
      this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
        super.update(t),
        (this._$Do = kt(e, this.renderRoot, this.renderOptions));
    }
    connectedCallback() {
  ...
  (k._$litElement$ = !0),
    (k.finalized = !0),
    V.litElementHydrateSupport?.({ LitElement: k });
  const xt = V.litElementPolyfillSupport;
  xt?.({ LitElement: k }), (V.litElementVersions ??= []).push("4.2.1");
  const Ut = (o) => (t, e) => {
    e !== void 0
      ? e.addInitializer(() => {
      ...
      typeof e == "object"
        ...
        : ((s, i, n) => {
            ...
            return (
              ...
              r ? Object.getOwnPropertyDescriptor(i, n) : void 0
            );
          })(o, t, e);
  }
  function B(o) {
    return Rt({ ...o, state: !0, attribute: !1 });
  }
  const Nt = (o, t, e) => (
    (e.configurable = !0),
    (e.enumerable = !0),
  ...
  var Dt = Object.defineProperty,
    ...
    x = (o, t, e, s) => {
      for (
        var i = s > 1 ? void 0 : s ? It(t, e) : t, n = o.length - 1, r;
        n >= 0;
        n--
      )
  ...
  let A = class extends k {
    ...
    _handleSelect(o) {
      this.hmm.setSinkId(o.target.value);
    }
    testEm() {
      console.log("Ring Ring Ring"), this.isActive && this.hmm.play();
    }
    stopEm() {
      this.hmm.load();
    }
    async listAudioDevices() {
      try {
        ...
        (this.audioDevices1 = t.map(
          (e) => nt`<option value=${e.deviceId}>${e.label}</option>`
        )),
          t.length > 0
            ? (console.log("Available audio devices:"),
              t.forEach((e) => {
                console.log(`  - Label: ${e.label || "Unknown Device"}`),
                  console.log(`    Kind: ${e.kind}`),
                  console.log(`    Device ID: ${e.deviceId}`),
                  console.log(`    Group ID: ${e.groupId}`);
              }))
            : (console.log("No audio devices found."), this.populateAudio());
      } catch (o) {
        console.error("Error enumerating devices:", o);
      }
    }
    render() {
      return nt`
        <div class=${this.hideMe ? "" : "bump"}>
            <button style="float: right;" @click=${() =>
              (this.hideMe = !this.hideMe)}>Second Ringer</button>
            <div class=${"container" + (this.hideMe ? " hidden" : "")}>
            <audio id="ring" src = "https://isam001.github.io/second-ringer/ring.mp3" type="audio/mp3" controls loop></audio>
  ...
  (A.styles = [
    ...
    x([B()], A.prototype, "audioDevices1", 2),
    x([B()], A.prototype, "hideMe", 2),
    x([B()], A.prototype, "isActive", 2),
    x([Ht("#ring")], A.prototype, "hmm", 2),
    (A = x([Ut("second-ringer")], A));
})();
